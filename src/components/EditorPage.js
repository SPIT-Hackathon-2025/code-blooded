...
//       {/* Compiler */}
//       <button className="btn position-fixed bottom-0 end-0 m-3" onClick={() => setIsCompileWindowOpen(!isCompileWindowOpen)} style={{ zIndex: 1050, backgroundColor: "#0ffaf3", fontFamily: "'Montserrat', sans-serif", fontSize: "14px", fontWeight: 500 }}>
...
//   useEffect(() => {
//     // Debugging logs
//     console.log("location.state:", location.state);  // Check location state
